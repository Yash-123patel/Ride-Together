    ...
    <section id="services" class="services">
        <div class="container">
            ...
            <div class="service-list">
                <div class="service">
                    <img src="logo.png" alt="Luxury Cars" class="service-icon">
                    <h3>Luxury Cars</h3>
                ...
                <div class="service">
                    <img src="logo.png" alt="Economy Cars" class="service-icon">
                    <h3>Economy Cars</h3>
                    <p>Our economy cars are budget-friendly and fuel-efficient, ideal for daily commutes and road trips.</p>
                </div>
                <div class="service">
                    <img src="logo.png" alt="Customer Support" class="service-icon">
